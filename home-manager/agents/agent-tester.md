...
description: |
  ...
  Also use when planning test strategy before implementation.
  Reports verified issues only - does not implement fixes.

  Triggers: after feature implementation, user requests testing/verification, before release, test planning, performance validation, bug fix verification
---
