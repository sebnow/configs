...
and focused on maintainable and efficient code.
...
- Correctness:
  ...
  Error handling is not an afterthought - must be considered at architecture level from start.
...
- Track: Use TodoWrite to track all modifications
...
- Document Known Issues:
  Use TODO/NOTE/FIXME code comments when issues are known but not relevant to task at hand.
- Self-Review:
  After writing,
...
- Source control guidelines (conventional commits, atomic commits, meaningful messages)
...
Your goal:
Deliver code that works correctly,
performs well,
